...
On ajoute un niveau de représentation : le **point de code**, un nombre, souvent noté en hexadécimal, qui correspond à la position d'un caractère dans la table Unicode mais n'est pas
...
Pour voir les représentations concrètes, on peut ouvrir les fichiers textes dans un éditeur
