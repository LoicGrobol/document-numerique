...
<p><b>DON RODRIGUE</b>
  Ôte-moi d'un doute. <br>
  Connais-tu bien Don Diègue ?
</p>
<p><b>LE COMTE</b> Oui.</p>
<p><b>DON RODRIGUE</b>
  Parlons bas, écoute.<br>
  …
</p>
```
...
En réalité les deux formats se sont essentiellement développés conjointement, avec des interactions
assez complexes.
...
On peut d'ailleurs vérifier tout de suite que ça ne marche pas en utilisant un *validateur
comme <https://www.truugo.com/xml_validator/> ou l'[extension XML de
vscode](https://marketplace.visualstudio.com/items?itemName=redhat.vscode-xml).
